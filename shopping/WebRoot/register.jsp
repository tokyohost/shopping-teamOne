...
<body>
	...
	<header>
		<nav>
			<div id="topNav">
				<ul>
					<li class="welcome">您好${user.uname}，欢迎光临网上显卡系统！请</li>
					<li><a href="<%=path%>/login.jsp">[登陆]</a></li>
					<li><a href="<%=path%>/register.jsp">[免费注册]</a></li>
					<li><a href="<%=path%>/cart.jsp">[查购购物车]</a></li>
					<li><a href="<%=path%>/order.jsp">[去购物车结算]</a></li>
				</ul>
			</div>
		</nav>
	</header>
	...
	<div id="registerdata">用户注册信息</div>
	...
	<!-- 脚部 -->
	<footer>
		<div class="copyright">Adams丶 © 2013. All Rights Reserved.</div>
	</footer>
